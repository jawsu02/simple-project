...
public class SessionVariablesApi {
    ...
    public String getSchemaFilesLocation() {
        return System.getProperty("user.dir") + "/src/test/resources/com/tcg/automation/schemaFiles/";
    }

    public String getQueryFilesLocation() {
        return System.getProperty("user.dir") + "/src/test/resources/com/tcg/automation/queryFiles/";
    }

    public String getUriResourcesFilePath() {
        return System.getProperty("user.dir") + "/src/test/resources/com/tcg/automation/config/url.properties";
    }
